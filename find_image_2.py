...
search_url = 'https://commons.wikimedia.org/w/api.php?action=query&generator=search&gsrsearch=Atyrau&gsrnamespace=6&gsrlimit=20&prop=imageinfo&iiprop=url&format=json'
